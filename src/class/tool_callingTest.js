    ...
    messages: [
      {
        role: "system",
        content:
          "You are a helpful assistant for artists. Call functions that are supplied to fulfill artists' request.",
      },
      {
        role: "user",
        content:
          "Give me suggestions for skills to imporve basing off of my skill tree profile",
      },
    ],
